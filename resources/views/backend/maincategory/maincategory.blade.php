...
<div class="breadcrumb-wrapper breadcrumb-contacts">
    <div>
        <h1>Add Maincategory</h1>
        <p class="breadcrumbs"><span><a href="{{route('home')}}">Dashboard</a></span>
            <span><i class="mdi mdi-chevron-right"></i></span>Add maincategory</p>
    </div>
    <div>
        ...
        <div class="ec-cat-list card card-default mb-24px">
            <div class="card-body">
                <div class="ec-cat-form">
                    ...
                    <form class="row" method="POST" action="{{route('maincategory.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-12">
                            <label for="text" class="col-form-label">maincategory name</label> 
                            <input id="text" name="maincategory_name" class="form-control" type="text" placeholder="Maincategory name">
