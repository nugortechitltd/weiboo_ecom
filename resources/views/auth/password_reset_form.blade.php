						...
						<div class="col-lg-6">
							<div class="login_area_left_wrapper">
								<div class="">
									...
									<p class="text-white" style="padding: 150px 60px 0 60px; text-align:center">Nulla laborum sit voluptate anim in. Nulla ut qui ex 
						...
						<div class="col-lg-6">
							<div class="login_area_right_wrapper">
								...
								<div class="login_form_wrapper">
									<form action="{{route('password.reset.set')}}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
											...
											<input type="password" name="password_confirmation" class="form-control @error('password') is-invalid @enderror" placeholder="Enter password">
