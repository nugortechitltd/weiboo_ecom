    ...
    <div class="container">
        <div class="breadcrumbs-inner">
            ...
            <ul>
                ...
                <li><a class="current-page" href="">Register</a></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="col-lg-8 col-md-12 m-auto">
                    <div class="register-form">
                        ...
                        <div>
                            <div class="card">
                                <div class="card-body">
                                    <div class="social-icon d-flex align-items-center justify-content-center">
										...
										<a href="{{route('facebook.redirect')}}" class="btn btn-secondary">
                            ...
                            <h3 class="mt-3 mb-3 m-auto text-center">Or, sign up with email</h3>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                @auth('customerauth')
                                ...
                                <form method="POST" action="{{route('customer.register.store')}}">
                                    ...
                                    <div class="d-inline">
                                        ...
                                        <a class="forgot-password text-danger" href="{{route('customer.login')}}">sign in</a>
                                    </div>
                                </form>
                                @endauth
