...
footer {
  ...
  <body>
    <header class="clearfix">
      ...
      @endphp
      <br> Credit Card Type: {{$pm == 1 ? 'NA':''}}<br> Transaction ID: {{App\Models\BillingDetails::where('order_id', $order_id)->first()->tran_id}}<a href="#" style="color: #ff0000; text-decoration:underline;">{{$pm == 1 ? 'NA': ''}}</a><br></div>
        <div></div>
      </div>
      <div id="project">
